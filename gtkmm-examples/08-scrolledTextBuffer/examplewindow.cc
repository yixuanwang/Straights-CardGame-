...
#include <fstream> // Read in some longer piece of text to test scrolling - CTK
#include <string>
using namespace std;
  ...
  m_Button_Buffer2("Use buffer 2")
{
  ...
  //  alternatives are: Gtk::POLICY_NEVER, Gtk::POLICY_ALWAYS
...
void ExampleWindow::fill_buffers()
{
  ...
  ifstream input( "1342-0.txt" ); // Project Gutenberg: "Pride and Prejudice" by Jane Austen
  string text;
  ...
  m_refTextBuffer2->set_text( text );
