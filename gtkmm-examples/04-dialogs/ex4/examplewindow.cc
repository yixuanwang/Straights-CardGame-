...
ExampleWindow::ExampleWindow() : m_ButtonBox{Gtk::ORIENTATION_VERTICAL}, m_FontButton{"Sans 10"}, m_Button_Dialog{"Choose Font"} {
  ...
  m_FontButton.signal_font_set().connect(sigc::mem_fun(*this, &ExampleWindow::on_font_button_font_set) );
